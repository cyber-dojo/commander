...
CYBER_DOJO_STARTER_BASE_IMAGE=${OVERRIDE_CYBER_DOJO_STARTER_BASE_IMAGE:-${CYBER_DOJO_STARTER_BASE_IMAGE}}
...
SCRIPT="${SCRIPT//CYBER_DOJO_STARTER_BASE_IMAGE/${CYBER_DOJO_STARTER_BASE_IMAGE}}"
